...
async def help_command(message: Message):
    try:
        logger.info(lang.log_command_executed.format(command='help', user_id=message.from_user.id))
        ...
        await message.answer("An unexpected error occurred while processing the help command. Please try again later.")
