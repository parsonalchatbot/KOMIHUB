        ...
        for filename in os.listdir(commands_dir):
            if filename.endswith('.py') and filename != '__init__.py':
                try:
                    ...
                    spec = importlib.util.spec_from_file_location(filename[:-3], os.path.join(commands_dir, filename))
                    ...
                    if hasattr(module, 'help') and callable(getattr(module, 'help')):
                        ...
                        if hasattr(module, 'command'):
                            ...
                            admin_only = 'db.is_admin(message.from_user.id)' in source or 'message.from_user.id != config.ADMIN_ID' in source
